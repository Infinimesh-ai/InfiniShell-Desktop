...
impl OnboardingPromptBlock {
    ...
    fn render_text(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Flex::column()
            .with_children([
                Container::new(
                    Text::new(
                        crate::t!("onboarding-prompt-setup-description"),
                        font_family,
                        font_size,
                    )
                    ...
                    FormattedTextElement::new(
                        FormattedText::new([FormattedTextLine::Line(vec![
                            FormattedTextFragment::plain_text(crate::t!(
                                "onboarding-prompt-custom-prompt-support"
                            )),
    ...
    fn render_existing_prompt_button_interior(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let prompt_body = if let Some((grid, size_info)) = &self.ps1_grid_info {
            ...
            Text::new_inline(
                crate::t!("onboarding-prompt-no-existing-prompt"),
                font_family,
                font_size,
            )
            .with_color(font_color.into_solid())
        ...
        Flex::column()
            .with_child(
                Container::new(
                    Text::new_inline(
                        crate::t!("onboarding-prompt-shell-prompt-title"),
                        font_family,
                        font_size,
                    )
                    .with_color(font_color.into_solid())
                ...
                Shrinkable::new(
                    ...
                    Align::new(
                        Flex::row()
                            .with_children([
                                Text::new_inline(
                                    crate::t!("onboarding-prompt-look-incorrect"),
                                    font_family,
                                    font_size,
                                )
                                .with_color(
                                ...
                                appearance
                                    .ui_builder()
                                    .link(
                                        crate::t!("onboarding-prompt-let-us-know"),
    ...
    fn render_warp_prompt_button_interior(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Flex::column()
            .with_child(
                Container::new(
                    Text::new_inline(
                        crate::t!("onboarding-prompt-infinishell-prompt-title"),
                        font_family,
            ...
            .with_child(
                Shrinkable::new(
                    ...
                    Align::new(
                        Text::new_inline(
                            crate::t!("onboarding-prompt-customizable-description"),
                            font_family,
                            ui_font_size,
                        )
