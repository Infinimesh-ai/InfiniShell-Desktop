...
use crate::workspace::view::{
    ...
    LEFT_PANEL_WARP_DRIVE_BINDING_NAME, NEW_AGENT_TAB_BINDING_NAME, NEW_FILE_BINDING_NAME,
...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            LEFT_PANEL_PROJECTS_BINDING_NAME,
            BindingDescription::new(crate::t!("keybinding-desc-workspace-left-panel-projects")),
            WorkspaceAction::ToggleProjectsPanel,
        )
        .with_group(bindings::BindingGroup::Navigation.as_str())
        .with_context_predicate(id!("Workspace"))
