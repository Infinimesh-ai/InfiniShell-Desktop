...
impl SyncDataSource for DiffSetDataSource {
    ...
    fn run_query(
        ...
        let uncommitted_changes_name = crate::t!("ai-context-diffset-uncommitted-changes");
        let main_branch_changes_name = crate::t!("ai-context-diffset-changes-vs-main-branch");
