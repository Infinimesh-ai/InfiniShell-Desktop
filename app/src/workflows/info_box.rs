...
use super::{AIWorkflowOrigin, WorkflowObject};
use crate::ai::blocklist::ai_brand_color;
use crate::appearance::Appearance;
use crate::cloud_object::StoredObjectMetadataExt;
...
impl WorkflowsMoreInfoView {
    ...
    fn render_info_box(
        ...
        match &self.workflow {
            WorkflowType::Cloud(workflow) => {
                let editing_history = workflow.metadata.semantic_editing_history(app);
                ...
                let edit_button = self.render_edit_button(workflow, appearance);
