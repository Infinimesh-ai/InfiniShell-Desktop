...
fn main() -> Result<()> {
    ...
    // 始终启用 IME marked-text 渲染:winit 的 IME 路径在 Linux / macOS / Windows 都支持,
...
embed_plist::embed_info_plist_bytes!(r#"
    ...
    <string>InfiniShell</string>
    <key>CFBundleExecutable</key>
    <string>infinishell</string>
    <key>CFBundleIdentifier</key>
    <string>dev.infinishell.InfiniShell</string>
    ...
    <array><dict><key>CFBundleURLName</key><string>Custom App</string><key>CFBundleURLSchemes</key><array><string>infinishell</string></array></dict></array>
    <key>NSHumanReadableCopyright</key>
    <string>© 2026, InfiniShell</string>
    </dict>
    </plist>
"#.as_bytes());
