...
use warpui::{
    AddSingletonModel, AppContext, AssetProvider, Entity, ModelContext, SingletonEntity, WindowId,
};
...
impl AppearanceManager {
    ...
    pub fn set_app_icon(&self, app: &AppContext) {
        ...
        autoreleasepool(|_| {
            ...
            let plugin_name = ns_string!("InfiniShellDockTilePlugin.docktileplugin");
