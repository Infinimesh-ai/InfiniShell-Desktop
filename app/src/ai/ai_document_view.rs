...
use warpui::elements::{
    ChildAnchor, ChildView, ConstrainedBox, Container, CrossAxisAlignment, Empty, Flex, Hoverable,
...
impl AIDocumentView {
    pub fn new(
        ...
        // Create sync button mouse state (for InfiniShell Drive syncing)
...
impl BackingView for AIDocumentView {
    ...
    fn pane_header_overflow_menu_items(
        ...
        // openWarp 本地化:云菜单项 "Copy Link" / "Show in InfiniShell Drive"
