...
pub(super) const MESSAGE_BRIDGE_CONTEXT_PREAMBLE: &str = "Lead-agent updates arrived from InfiniShell Agent. Treat the latest lead-agent instructions below as authoritative.\n";
