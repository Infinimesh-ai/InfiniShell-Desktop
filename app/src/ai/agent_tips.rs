...
static DEFAULT_TIPS: LazyLock<Vec<AgentTip>> = LazyLock::new(|| {
    vec![
        ...
        AgentTip {
            ...
            link: Some("".to_string()),
            binding_name: None,
            action: Some(WorkspaceAction::InfiniShellDrive),
            kind: AgentTipKind::InfiniShellDrive,
        },
        AgentTip {
...
impl WorkspaceAction {
    pub fn display_text(&self) -> Option<String> {
        match self {
            ...
            WorkspaceAction::InfiniShellDrive => Some(crate::t!("agent-tip-action-warp-drive")),
