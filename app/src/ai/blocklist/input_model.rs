...
use crate::terminal::shared_session::protocol::{InputMode, InputType as ProtocolInputType};
...
impl BlocklistAIInputModel {
    ...
    pub fn is_autodetection_enabled_for_current_context(&self, app: &AppContext) -> bool {
        ...
        // per-keystroke. The conversation-activation subscriber and `set_input_mode_agent`
        // already lock at entry; this guard protects the window if any future caller forgets.
