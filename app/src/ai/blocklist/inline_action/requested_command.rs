...
use crate::settings::{InputModeSettings, SelectionSettings};
...
pub struct RequestedCommandView {
    ...
    // A requested command can either be copied directly off of one citation (such as an InfiniShell Drive
            ...
            (
                ...
                *shown.lock() = true;
                Some(render_autonomy_checkbox_setting_speedbump_footer(
                    "Always allow InfiniShell Agent to execute read-only commands (relies on model)",
                    *checked,
