...
use crate::ui_components::icon_with_status::render_cli_agent_logo;
...
use warpui::elements::{
    ...
    CrossAxisAlignment, DEFAULT_UI_LINE_HEIGHT_RATIO, DispatchEventResult, Element, EventHandler,
    Expanded, Flex, MainAxisAlignment, MainAxisSize, OffsetPositioning, ParentElement,
