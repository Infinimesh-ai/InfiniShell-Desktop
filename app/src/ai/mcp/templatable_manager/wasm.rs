...
impl TemplatableMCPServerManager {
    ...
    /// Updates a TemplatableMCPServer in InfiniShell Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Gets all TemplatableMCPServers currently in InfiniShell Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Creates a new TemplatableMCPServer in InfiniShell Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Deletes a TemplatableMCPServer from InfiniShell Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
