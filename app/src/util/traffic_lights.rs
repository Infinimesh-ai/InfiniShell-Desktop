...
//! depends on the platform. The Zap app must use this information to avoid rendering UI elements
//! underneath them.
...
/// Data the Zap app needs to avoid rendering anything below the traffic lights.
#[derive(Clone, Debug)]
