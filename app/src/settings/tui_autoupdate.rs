...
define_settings_group!(TuiAutoupdateSettings, settings: [
    // Whether the `infinishell-tui` background auto-updater is enabled.
    //
    ...
    // settings file. Read once at TUI startup; the `INFINISHELL_TUI_DISABLE_AUTOUPDATE`
    ...
    autoupdate_enabled: TuiAutoupdateEnabled {
        ...
        description: "Whether InfiniShell TUI automatically installs updates in the background.",
    },
]);
