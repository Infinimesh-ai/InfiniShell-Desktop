...
zap-launch-oad-description = InfiniShell 仓库由智能体优先的本地工作流管理，并由 Oz 本地智能体体验提供支持。
...
onboarding-free-user-agent-description = 使用 Oz（InfiniShell 内置智能体）迭代、规划和构建。本地运行，不依赖 InfiniShell 云服务。
