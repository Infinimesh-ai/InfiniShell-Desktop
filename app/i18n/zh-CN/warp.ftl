...
ai-block-auto-approve-this-task = 为此任务自动批准
ai-block-full-access-this-task = 为此任务启用完全访问
ai-block-auto-approve-this-session = 为此会话自动批准
ai-block-full-access-this-session = 为此会话启用完全访问
