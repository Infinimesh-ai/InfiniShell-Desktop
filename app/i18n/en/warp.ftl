...
settings-agent-providers-models-empty-hint = No models configured yet. Click [+ Add model] to add one manually, or [Refresh from API] to load the provider's current list.
