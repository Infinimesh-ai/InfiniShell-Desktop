...
cli-task-manager-queue-next-turn = Queue next turn
cli-task-manager-claude-queued = Claude has an instruction waiting to start. Confirmed receipt does not mean execution. Cancel turn only interrupts the current turn; the queued instruction may still run.
cli-agent-claude-queue-full = A Claude instruction is already waiting to start. Keep this draft until that turn starts.
