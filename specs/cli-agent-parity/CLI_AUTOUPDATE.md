...
2026-09-23 13:37 UTC 最新复核见 [receipt132](validation/version-discovery-132-20260923-latest-drift.safe.json)：Codex 官方稳定版已发布 `0.156.1`，Claude 官方 latest 为 `2.1.280`，Grok stable 隔离查询仍为 `1.0.41`。下文 `0.155.1`／`2.1.278` 版本与渠道表保留为 2026-09-21 历史快照；新版 Codex 已通过零输入协议预检及 [receipt135](validation/macos-clean-commit-135-2c00b045-codex-01561-missing-session.safe.json) 的无凭据 Rust 适配器缺失会话路径，新版 Claude 已通过 [receipt134](validation/macos-clean-commit-134-952c0ec0-claude-21280-no-credentials.safe.json) 的无凭据原生启动／退出与 [receipt136](validation/macos-working-tree-136-2c00b045-claude-21280-lifecycle.safe.json) 的 test-only Rust 适配器在线基本链。receipt136 运行时工作树不干净；两款新版的正式产品版本门禁仍关闭，三款自动升级事务均未因这些阶段性探针获得新版验收，最终 P0–P5 不得沿用旧版结论。
