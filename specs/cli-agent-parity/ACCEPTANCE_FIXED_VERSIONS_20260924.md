...
| P5 平台、提交和报告；R8 | `.github/workflows/cross-platform-preflight.yml`、本表和验证收据 | [最终源码对应](validation/macos-fixed-versions-20260924/source-binding-b3acf2a69.safe.json)、[未变域复用审计](validation/macos-fixed-versions-20260924/ci-72caebfc8-source-reuse.safe.json)；Linux／Windows 全量 10,899／10,660 项通过按原提交保留；Linux 与 Windows 真实 GUI 已通过；`b3acf2a69` 的[Windows 两项补验](https://github.com/Infinimesh-ai/InfiniShell-Desktop/actions/runs/36028161259)已通过 Grok 插件迁移与 Codex 原子更新 | 已完成；Windows 本轮 571 项相关回归、严格 Job 和清理通过；未重跑未变全量，旧 GUI 二进制不重标 |
