...
| P5 平台、提交和报告；R8 | `.github/workflows/cross-platform-preflight.yml`、本表和验证收据 | [源码对应](validation/macos-fixed-versions-20260924/source-binding-981cfebc4.safe.json)、[Mac 复用审计](validation/macos-fixed-versions-20260924/ci-981cfebc4-mac-source-reuse.safe.json)；Linux／Windows 全量 10,899／10,660 项通过按原提交保留；当前 `981cfebc4` 的[集中补验](https://github.com/Infinimesh-ai/InfiniShell-Desktop/actions/runs/36015553498)执行剩余原生能力和 GUI | 待实际结果与报告闭环；未重跑已通过且源码未变的全量范围，旧 GUI 二进制不重标 |
