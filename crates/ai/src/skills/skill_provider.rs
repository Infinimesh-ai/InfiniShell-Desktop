...
impl SkillProvider {
    ...
    pub fn icon(&self) -> Icon {
        match self {
            ...
            SkillProvider::Grok => Icon::GrokLogo,
...
pub static SKILL_PROVIDER_DEFINITIONS: LazyLock<Vec<SkillProviderDefinition>> =
    LazyLock::new(|| {
        vec![
            ...
            SkillProviderDefinition {
                provider: SkillProvider::Grok,
                skills_path: PathBuf::from(".grok").join("skills"),
            },
            SkillProviderDefinition {
...
/// Returns the scope for a local skill path: skills living under one of the
/// providers' home skill directories are personal (home) scoped, everything else
/// is project scoped.
