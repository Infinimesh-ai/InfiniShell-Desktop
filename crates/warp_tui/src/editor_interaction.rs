...
fn editor_command_description(command: TuiEditorCommand) -> &'static str {
    match command {
        TuiEditorCommand::InsertNewline => warp::t_static!("tui-editor-insert-newline"),
        TuiEditorCommand::Backspace => warp::t_static!("tui-editor-delete-previous-character"),
        TuiEditorCommand::DeleteForward => warp::t_static!("tui-editor-delete-next-character"),
        TuiEditorCommand::DeleteWordBackward => warp::t_static!("tui-editor-delete-previous-word"),
        TuiEditorCommand::DeleteWordForward => warp::t_static!("tui-editor-delete-next-word"),
        TuiEditorCommand::MoveLeft => warp::t_static!("tui-editor-move-left"),
        TuiEditorCommand::MoveRight => warp::t_static!("tui-editor-move-right"),
        TuiEditorCommand::MoveUp => warp::t_static!("tui-editor-move-up"),
        TuiEditorCommand::MoveDown => warp::t_static!("tui-editor-move-down"),
        TuiEditorCommand::MoveWordLeft => warp::t_static!("tui-editor-move-word-left"),
        TuiEditorCommand::MoveWordRight => warp::t_static!("tui-editor-move-word-right"),
        TuiEditorCommand::MoveToLineStart => warp::t_static!("tui-editor-move-line-start"),
        TuiEditorCommand::MoveToLineEnd => warp::t_static!("tui-editor-move-line-end"),
        TuiEditorCommand::SelectLeft => warp::t_static!("tui-editor-select-left"),
        TuiEditorCommand::SelectRight => warp::t_static!("tui-editor-select-right"),
        TuiEditorCommand::SelectUp => warp::t_static!("tui-editor-select-up"),
        TuiEditorCommand::SelectDown => warp::t_static!("tui-editor-select-down"),
        TuiEditorCommand::SelectWordLeft => warp::t_static!("tui-editor-select-word-left"),
        TuiEditorCommand::SelectWordRight => warp::t_static!("tui-editor-select-word-right"),
        TuiEditorCommand::SelectToLineStart => warp::t_static!("tui-editor-select-line-start"),
        TuiEditorCommand::SelectToLineEnd => warp::t_static!("tui-editor-select-line-end"),
        TuiEditorCommand::SelectAll => warp::t_static!("tui-editor-select-all"),
        TuiEditorCommand::Copy => warp::t_static!("tui-editor-copy"),
        TuiEditorCommand::Cut => warp::t_static!("tui-editor-cut"),
        TuiEditorCommand::Paste => warp::t_static!("tui-editor-paste"),
        TuiEditorCommand::KillToLineEnd => warp::t_static!("tui-editor-delete-line-end"),
        TuiEditorCommand::KillToLineStart => warp::t_static!("tui-editor-delete-line-start"),
        TuiEditorCommand::Yank => warp::t_static!("tui-editor-yank"),
        TuiEditorCommand::Undo => warp::t_static!("tui-editor-undo"),
        TuiEditorCommand::Redo => warp::t_static!("tui-editor-redo"),
    }
}
...
pub(crate) fn editor_binding_specs(
    ...
    SHARED_EDITOR_BINDINGS.iter().filter_map(move |spec| {
        ...
        Some(TuiEditorBindingSpec {
            ...
            name,
            description: editor_command_description(spec.command),
            keys: spec.keys,
        })
    })
}
