...
lazy_static! {
    ...
    // Zap 独有:SSH 服务器搜索过滤器(SSH manager 功能)。
...
pub enum QueryFilter {
    ...
    /// Zap 独有:过滤 SSH manager 里已保存的 SSH 服务器。
    SshServers,
...
impl QueryFilter {
    ...
    pub fn placeholder_text(&self) -> &'static str {
        match self {
            ...
            QueryFilter::SshServers => "Search SSH servers",
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ...
            QueryFilter::SshServers => "SSH servers",
    ...
    pub fn icon_svg_path(&self) -> Option<&'static str> {
        match self {
            ...
            QueryFilter::Drive => Some("bundled/svg/infinishell-drive.svg"),
