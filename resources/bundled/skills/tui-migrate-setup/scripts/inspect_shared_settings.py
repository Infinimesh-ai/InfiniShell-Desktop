#!/usr/bin/env python3
"""Inspect only GUI settings explicitly supported by both GUI and InfiniShell TUI."""
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Inspect GUI settings declared for both Warp GUI and InfiniShell TUI."
    )
